...
# Utilizzare una struttura if per determinare se n è un numero primo. Un numero primo è divisibile solo per 1 e per se stesso. Il programma deve stampare se
# n è primo o no.
# Stampare tutto
import tools
...
somma_pari = 0
#for numeri pari con il calcolo della somma
...
tools.numero_primo(n) #richiamiamo la funzione numero primo
